...
class GUI:
    ...
    def main_window(self):
        self.app = App(title="Bilder kopieren", width=800, height=300)
        welcome = Text(self.app, "Wilkommen in der Bilder Kopier App.", size=20)
        enter = Text(self.app, "Gib bitte im Feld unten den Namen des Ordners ein in dem du deine Bilder kopieren möchtest. "
        ...
        OK = PushButton(self.app, text="BESTÄTIGEN", command=info,
                        args=["INFO", "Die Bilder werden kopiert. \nDu kannst nun das Fenster schließen"])
